...
#SBATCH --job-name="gen-masks"
#SBATCH --open-mode=append
#SBATCH --output="/cluster/home/kzaitse/outputs/gen-masks/gen-masks-%j.txt"
...
cd /cluster/home/kzaitse/monodepth_project/notebooks || exit 1
python gen_masks.py "$@"
